                    ...
                    <table class="table table-striped">
                        ...
                        <tr>         
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#tanggapi<?php echo $data['id_pengaduan'] ?>" >TANGGAPI</button>
                                   ...
                                   <div class="modal-dialog">
                                       <div class="modal-content">
                                           ...
                                           <div class="modal-body">
                                               ...
                                               <input type="hidden" name="id_pengaduan" class="form-control" value="<?php echo $data['id_pengaduan'] ?>">
                                              <p>Apakah anda yakin ingin menghapus data ini? <br><?php echo $data['judul_laporan'] ?></p>
                                           </div>
                                           <div class="modal-footer">
